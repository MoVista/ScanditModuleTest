...
class DataCaptureContextProxy {
    ...
    unsubscribeListener() {
        ...
        DataCaptureContextProxy_coreNative.removeEventListener(DataCaptureContextListenerName.didChangeStatus, () => { });
        DataCaptureContextProxy_coreNative.removeEventListener(DataCaptureContextListenerName.didStartObservingContext, () => { });
    ...
    subscribeListener() {
        // @ts-ignore
        DataCaptureContextProxy_coreNative.addEventListener(DataCaptureContextListenerName.didChangeStatus, (body) => {
            const contextStatus = ContextStatus.fromJSON(JSON.parse(body.status));
            this.notifyListenersOfDidChangeStatus(contextStatus);
        });
        DataCaptureContextProxy_coreNative.addEventListener(DataCaptureContextListenerName.didStartObservingContext, () => {
...
class DataCaptureViewProxy {
    ...
    subscribeListener() {
        // @ts-ignore
        DataCaptureViewProxy_coreNative.addEventListener(DataCaptureViewListenerName.didChangeSize, (body) => {
    ...
    unsubscribeListener() {
        ...
        DataCaptureViewProxy_coreNative.removeEventListener(DataCaptureViewListenerName.didChangeSize, () => { });
    }
}
...
class CameraProxy {
    ...
    subscribeListener() {
        // @ts-ignore
        CameraProxy_coreNative.addEventListener(FrameSourceListenerName.didChangeState, (body) => {
    ...
    unsubscribeListener() {
        // tslint:disable-next-line:no-empty
        CameraProxy_coreNative.removeEventListener(FrameSourceListenerName.didChangeState, () => { });
    }
}
