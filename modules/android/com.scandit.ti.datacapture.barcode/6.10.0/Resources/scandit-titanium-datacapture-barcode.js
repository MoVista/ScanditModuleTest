...
class BarcodeCaptureListenerProxy {
    ...
    subscribeListener() {
        // @ts-ignore
        barcodeNative.addEventListener(BarcodeCaptureListenerEventName.didUpdateSession, (body) => {
        ...
        // @ts-ignore
        barcodeNative.addEventListener(BarcodeCaptureListenerEventName.didScan, (body) => {
            const session = BarcodeCaptureSession.fromJSON(JSON.parse(body.session));
    ...
    unsubscribeListener() {
        ...
        barcodeNative.removeEventListener(BarcodeCaptureListenerEventName.didUpdateSession, () => { });
        barcodeNative.removeEventListener(BarcodeCaptureListenerEventName.didScan, () => { });
